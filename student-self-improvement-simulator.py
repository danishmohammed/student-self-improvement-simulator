...
def breakfast():
  ...
  breakfast_reply = input("(Enter 1, 2 or 3): ")
...
def first_class():
  ...
  first_class_reply = input("(Enter 1, 2 or 3): ")
...
def second_class():
  ...
  second_class_reply = input("(Enter 1, 2 or 3): ")
  ...
  if second_class_reply == "1":
    ...
    print("\nI text in the chat 'are you okay?'")
    time.sleep(4)
    ...
    print("\nYou text your friend after class: 'Hey, is everything alright? Im always here if you ever need someone to talk to.'")
    time.sleep(4)
...
def lunch():
  time.sleep(4)
  print("\nAnyways, you say bye to your teacher and it’s finally lunchtime! How would you plan out the next hour?")
  ...
  if lunch_reply == "1":
    ...
    print("\nI'm up and moving. I go for a walk/jog around the block.")
    time.sleep(4)
...
def test():
  time.sleep(4) 
  print("\nHopefully you got to enjoy a nice meal at some point, who doesn't love a good lunch? Today, you have a test for all of third period and you just re-loaded the screen to see the test posted in your Google Classroom. How do you feel?")
  ...
  if test_reply == "1":
    ...
    print("\nYou quickly scramble your notes and try to intak eas mcuh as you can!")
    time.sleep(4)
    ...
    print("\nYou casually open the test, not caring about it whatsoever")
    time.sleep(4)
...
def email():
  time.sleep(4)
  print("\nPhew! You may now take a 10-minute breather, your test is over! As you slump back in your chair, you get an email from a skeptical and seemingly dangerous sender. That's strange, what do you want to do with it?")
  ...
  email_reply = input("(Enter 1, 2 or 3): ")
...
def after_school():
  time.sleep(4)
  print("\nAt last, you attend your final class, math, and upon your last equation, School is finally over! Give yourself a pat on the back for another day of school complete! What now?")
  ...
  after_school_reply = input("(Enter 1, 2 or 3): ")
...
def hangout():
  ...
  hangout_reply = input("(Enter 1, 2 or 3): ")
...
def covid():
  ...
  covid_reply = input("(Enter 1, 2 or 3): ")
...
def dinner():
  ...
  dinner_reply = input("(Enter 1, 2 or 3): ")
...
def sleep():
  ...
  sleep_reply = input("(Enter 1, 2 or 3): ")
